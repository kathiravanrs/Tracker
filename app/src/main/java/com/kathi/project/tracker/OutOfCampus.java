...
public class OutOfCampus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_out_of_campus);

        FirebaseApp.initializeApp(this);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mMessagesDatabaseReference = mFirebaseDatabase.getReference().child("Out_campus");
//        Log logMessage = new Log("here", "him", "now");
//        mMessagesDatabaseReference.push().setValue(logMessage);

        mListView = findViewById(R.id.activity_out_of_campus);
